use prettier.completions.nu [
  `nu-complete prettier arrow-parens`,
  `nu-complete prettier config-precedence`,
  `nu-complete prettier embedded-language-formatting`,
  `nu-complete prettier end-of-line`,
  `nu-complete prettier html-whitespace-sensitivity`,
  `nu-complete prettier loglevel`,
  `nu-complete prettier parser`,
  `nu-complete prettier prose-wrap`,
  `nu-complete prettier quote-props`,
  `nu-complete prettier trailing-comma`,
]
